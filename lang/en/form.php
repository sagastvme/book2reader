...
return [
    'books' => 'Upload books',
    'books_help' => 'Supported formats: :formats.',
    'url' => 'Link',
    ...
    'id_helper' => 'Enter the same id on both devices to set up the connection',
    'id' => 'Connection id',
    ...
    'transliterate_help' => 'Converts non-latin characters into their latin equivalents for better e-reader compatibility (e.g. "Привет" → "Privet", "Ελλάδα" → "Ellada").',    'process' => [
        ...
        'kobo' => 'Kobo (Kepubify)',
        'kobo_desc' => 'Converts the EPUB to the enhanced Kobo format (KEPUB).',
